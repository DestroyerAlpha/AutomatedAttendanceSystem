                            ...
                            <?php 
                                ...
                                if (isset($_POST['register']) && isset($_POST['c_code']))
                                {
                                    ...
                                    if($k==1){
                                        ...
                                        $query    = "INSERT INTO $course_code VALUES"."('$_SESSION["stu_user"]')";
                                        $result   = $conn->query($query);
                                        ...
                                        for ($j = 0 ; $j < $rows ; ++$j)
                                        {
                                            ...
                                            if($r0 == $_SESSION["stu_user"]){
                                                $no_of_courses = $r3+1;
                                                $query  = "UPDATE students SET no_of_courses='$no_of_courses' WHERE username='$_SESSION["stu_user"]'";  
                                                $result = $conn->query($query); 
